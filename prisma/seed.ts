...
async function seedAdmin() {
  const phone = process.env.ADMIN_PHONE ?? "09120000001";
  const email = process.env.ADMIN_EMAIL ?? "admin@lafemme.ir";
  const password = process.env.ADMIN_PASSWORD ?? "LaFemme@2026";
