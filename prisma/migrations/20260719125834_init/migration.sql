...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('ONLINE', 'CARD_TO_CARD', 'CASH_ON_DELIVERY', 'WALLET');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('GENERAL', 'ORDER', 'PAYMENT', 'INVENTORY', 'SYSTEM');

-- CreateEnum
CREATE TYPE "PreOrderStatus" AS ENUM ('PENDING', 'CONTACTED', 'CONFIRMED', 'CANCELLED', 'COMPLETED');
...
CREATE TABLE "Order" (
    ...
    "shippingAmount" DECIMAL(18,0) NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE INDEX "MarketPrice_productId_recordedAt_idx" ON "MarketPrice"("productId", "recordedAt");

-- CreateIndex
CREATE INDEX "MarketPrice_title_recordedAt_idx" ON "MarketPrice"("title", "recordedAt");
...
-- CreateIndex
CREATE INDEX "PreOrder_userId_createdAt_idx" ON "PreOrder"("userId", "createdAt");

-- CreateIndex
CREATE INDEX "PreOrder_productId_status_idx" ON "PreOrder"("productId", "status");

-- CreateIndex
CREATE INDEX "PreOrder_variantId_idx" ON "PreOrder"("variantId");

-- CreateIndex
CREATE INDEX "PreOrder_deletedAt_idx" ON "PreOrder"("deletedAt");
...
-- AddForeignKey
ALTER TABLE "PreOrder" ADD CONSTRAINT "PreOrder_variantId_fkey" FOREIGN KEY ("variantId") REFERENCES "ProductVariant"("id") ON DELETE SET NULL ON UPDATE CASCADE;
